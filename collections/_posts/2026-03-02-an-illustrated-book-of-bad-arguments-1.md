...
categories: [logic, critical-thinking, logical-fallacies, philosophy, books, reasoning]
permalink: /blog/books/an-illustrated-book-of-bad-arguments/1/
---

* TOC
{:toc}

This book genuinely changed how I think about many everyday arguments. The examples feel surprisingly familiar-  they’re the kinds of claims I’ve actually heard in real life. So if an example appears here, chances are I’ve encountered it myself. No offense intended to anyone; in hindsight, many of these moments are simply funny and human.
...
Arguments like this are faulty because they try to support or deny a statement’s *truth* based solely on its consequences.
...
A straw man occurs when someone **purposefully** misrepresents, oversimplifies, misquotes, misconstrues an opponent's position, to make it easier to attack them.
...
- ***If you’re not studying all the time, then you have no future.***  
- ***If I dont become a doctor or an engineer, I'm just a failure.***
...
- ***I can’t say that, because in 1976 I did a drawing of a robot and then Star Wars came out, they must have copied the idea from me.*** [^2]

Some of you may know this idea as: **correlation ≠ causation**.[^cc]
![xkcd-552](https://imgs.xkcd.com/comics/correlation.png)
...
- ***A scammer calls and tells me to share my OTP (one time password) or else I could lose a brand new Skoda*** [^scam]
...
Animal Farm also illustrates this tactic through propaganda and fear-based control. You can read my thoughts on it [here]({{ "/blog/books/animal-farm/" | relative_url }})
...
- ***One engineering graduate I hired couldn’t code properly. Engineering colleges don’t teach anything useful.***

A few personal experiences are treated as enough evidence to judge an entire group. [^hg]
...
- ***No one has proven that this stock-market ‘guru’ is fake, so his advice must be genuine- better to buy his course***
...
***“Most doctors are only after money.”***  
*When shown examples of doctors who earn modestly and work long, demanding hours, the response becomes:*  
***“Well, no real doctors are like that- I meant doctors from the newer generation.”***
...
[^cc]: [Correlation does not imply causation](https://en.wikipedia.org/wiki/Correlation_does_not_imply_causation)
[^scam]: Many scams exploit fear, urgency, greed, or panic. [You are digitally arrested](https://bbc.com/news/articles/cdrdyxk4k4ro).
[^hg]: Larger, representative samples are required before making general claims. See: [Hasty generalization](https://en.wikipedia.org/wiki/Faulty_generalization).
